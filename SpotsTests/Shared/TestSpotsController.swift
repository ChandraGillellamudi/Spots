...
class SpotsControllerTests: XCTestCase {
  ...
  func testReloadIfNeededWithComponentModels() {
    ...
    XCTAssertEqual(controller.components.first!.sizeCache.size(at: 0), components.first!.model.items[0].size)
    ...
    #if !os(OSX)
      XCTAssertEqual(controller.components.first!.sizeCache.size(at: 0), CGSize(width: controller.view.frame.width, height: view!.computeSize(for: controller.components.first!.model.items[0]).height))
      XCTAssertEqual(controller.components.first!.sizeCache.size(at: 0), view!.frame.size)
    #endif
    ...
    #if !os(OSX)
      XCTAssertEqual(controller.components.first!.sizeCache.size(at: 1), CGSize(width: controller.view.frame.width, height: view!.computeSize(for: controller.components.first!.model.items[1]).height))
      XCTAssertEqual(controller.components.first!.sizeCache.size(at: 1), view!.frame.size)
    #endif
    ...
    #if !os(OSX)
      XCTAssertEqual(controller.components.first!.sizeCache.size(at: 2), CGSize(width: controller.view.frame.width, height: view!.computeSize(for: controller.components.first!.model.items[2]).height))
      XCTAssertEqual(controller.components.first!.sizeCache.size(at: 2), view!.frame.size)
    #endif
    ...
    #if !os(OSX)
      XCTAssertEqual(controller.components.first!.sizeCache.size(at: 3), CGSize(width: controller.view.frame.width, height: view!.computeSize(for: controller.components.first!.model.items[3]).height))
      XCTAssertEqual(controller.components.first!.sizeCache.size(at: 3), view!.frame.size)
    #endif
    ...
    #if !os(OSX)
      XCTAssertEqual(controller.components.first!.sizeCache.size(at: 4), CGSize(width: controller.view.frame.width, height: view!.computeSize(for: controller.components.first!.model.items[4]).height))
      XCTAssertEqual(controller.components.first!.sizeCache.size(at: 4), view!.frame.size)
    #endif
    ...
    #if !os(OSX)
      XCTAssertEqual(controller.components.first!.sizeCache.size(at: 5), CGSize(width: controller.view.frame.width, height: view!.computeSize(for: controller.components.first!.model.items[5]).height))
      XCTAssertEqual(controller.components.first!.sizeCache.size(at: 5), view!.frame.size)
    #endif
    ...
    controller.reloadIfNeeded(newComponentModels) {
      ...
      XCTAssertNotEqual(controller.components.first!.sizeCache.size(at: 0), newComponentModels.first!.items[0].size)
      #if !os(OSX)
        XCTAssertEqual(controller.components.first!.sizeCache.size(at: 0), CGSize(width: controller.view.frame.width, height: view!.computeSize(for: controller.components.first!.model.items[0]).height))
        XCTAssertEqual(controller.components.first!.sizeCache.size(at: 0), view!.frame.size)
      #endif
      ...
      XCTAssertNotEqual(controller.components.first!.sizeCache.size(at: 1), newComponentModels.first!.items[1].size)
      #if !os(OSX)
        XCTAssertEqual(controller.components.first!.sizeCache.size(at: 1), CGSize(width: controller.view.frame.width, height: view!.computeSize(for: controller.components.first!.model.items[1]).height))
        XCTAssertEqual(controller.components.first!.sizeCache.size(at: 1), view!.frame.size)
      #endif
      ...
      XCTAssertNotEqual(controller.components.first!.sizeCache.size(at: 2), newComponentModels.first!.items[2].size)
      #if !os(OSX)
        XCTAssertEqual(controller.components.first!.sizeCache.size(at: 2), CGSize(width: controller.view.frame.width, height: view!.computeSize(for: controller.components.first!.model.items[2]).height))
        XCTAssertEqual(controller.components.first!.sizeCache.size(at: 2), view!.frame.size)
      #endif
      ...
      XCTAssertNotEqual(controller.components.first!.sizeCache.size(at: 3), newComponentModels.first!.items[3].size)
      #if !os(OSX)
        XCTAssertEqual(controller.components.first!.sizeCache.size(at: 3), CGSize(width: controller.view.frame.width, height: view!.computeSize(for: controller.components.first!.model.items[3]).height))
        XCTAssertEqual(controller.components.first!.sizeCache.size(at: 3), view!.frame.size)
      #endif
      ...
      XCTAssertNotEqual(controller.components.first!.sizeCache.size(at: 4), newComponentModels.first!.items[4].size)
      #if !os(OSX)
        XCTAssertEqual(controller.components.first!.sizeCache.size(at: 4), CGSize(width: controller.view.frame.width, height: view!.computeSize(for: controller.components.first!.model.items[4]).height))
        XCTAssertEqual(controller.components.first!.sizeCache.size(at: 4), view!.frame.size)
      #endif
      ...
      XCTAssertNotEqual(controller.components.first!.sizeCache.size(at: 5), newComponentModels.first!.items[5].size)
      #if !os(OSX)
        XCTAssertEqual(controller.components.first!.sizeCache.size(at: 5), CGSize(width: controller.view.frame.width, height: view!.computeSize(for: controller.components.first!.model.items[5]).height))
        XCTAssertEqual(controller.components.first!.sizeCache.size(at: 5), view!.frame.size)
      #endif
